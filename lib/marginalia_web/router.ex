defmodule MarginaliaWeb.Router do
  ...
  scope "/", MarginaliaWeb do
    ...
    live_session :redirect_if_user_is_authenticated,
      on_mount: [{MarginaliaWeb.UserAuth, :redirect_if_user_is_authenticated}] do
  ...
  scope "/", MarginaliaWeb do
    ...
    live_session :require_authenticated_user,
      on_mount: [{MarginaliaWeb.UserAuth, :ensure_authenticated}] do
  ...
  scope "/", MarginaliaWeb do
    ...
    live_session :current_user,
      on_mount: [{MarginaliaWeb.UserAuth, :mount_current_user}] do
